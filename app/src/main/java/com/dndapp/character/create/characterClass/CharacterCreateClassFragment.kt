...
import com.dndapp.databinding.FragmentCharacterCreateClassBinding
import com.dndapp.extensions.sharedGraphViewModel
import org.koin.androidx.viewmodel.ext.android.viewModel


class CharacterCreateClassFragment : Fragment() {

    private val sharedViewModel by sharedGraphViewModel<CharacterCreateViewModel>(
        R.id.character_create_graph
    )
    private val viewModel by viewModel<CharacterCreateClassViewModel>()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return FragmentCharacterCreateClassBinding.inflate(inflater, container, false).also {
